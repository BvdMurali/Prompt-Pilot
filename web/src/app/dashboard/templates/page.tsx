      ...
      {!selectedId ? (
        ...
        <div className="flex-1 flex flex-col gap-6 w-full animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-between border-b border-slate-100 pb-4">
            <div>
              <h2 className="text-base font-extrabold text-slate-900 tracking-tight">System Templates</h2>
              <p className="text-xs text-slate-500 mt-0.5">Select a template to configure variables and generate prompts</p>
            </div>
            ...
            <div className="relative w-full sm:max-w-xs md:max-w-sm">
              ...
              <input
                ...
                className="w-full bg-white border border-slate-200 rounded-xl pl-10 pr-4 py-2 text-sm text-slate-800 outline-none focus:border-indigo-500 transition-all shadow-sm"
              />
            </div>
          </div>
          ...
          {filteredTemplates.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 border border-dashed border-slate-200 rounded-2xl bg-white shadow-sm w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {filteredTemplates.map((t) => (
                <button
                  ...
                  className="p-5 xl:p-6 rounded-2xl bg-white border border-slate-200 hover:border-slate-300 shadow-sm hover:shadow-md hover:scale-[1.01] active:scale-[0.99] transition-all text-left flex flex-col gap-4 relative group cursor-pointer"
                >
                  ...
                  <div className="flex-1">
                    <h4 className="text-sm font-bold text-slate-900 mb-1.5 group-hover:text-indigo-650 transition-colors">{t.title}</h4>
                    <p className="text-xs text-slate-500 leading-relaxed line-clamp-3">{t.description}</p>
                  </div>
                  <div className="border-t border-slate-100 pt-3 flex items-center justify-between text-xs font-bold text-indigo-650 mt-1 w-full">
        ...
        <div className="flex-1 flex flex-col gap-6 xl:gap-8 w-full animate-fade-in">
          {/* Header navigation bar */}
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-between border-b border-slate-100 pb-4">
            <button
              onClick={() => setSelectedId(null)}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-slate-200 hover:bg-slate-50 text-slate-650 hover:text-slate-900 text-xs font-semibold rounded-lg shadow-sm transition-all cursor-pointer animate-fade-in"
            >
              ...
              {filteredTemplates.map((t) => (
                ...
                >
                  <div className="flex justify-between items-start gap-2 mb-1.5">
                    <span className="text-[9px] px-1.5 py-0.5 rounded bg-indigo-50 border border-indigo-100 text-indigo-700 font-bold uppercase tracking-wider">
                      {t.tags[0]}
                    </span>
                  </div>
                  ...
                  <p className="text-[11px] text-slate-500 leading-relaxed line-clamp-1">{t.description}</p>
                </button>
              ))}
            </div>
                        ...
                        <div key={varName} className="flex flex-col gap-1.5 xl:gap-2">
                          ...
                          {isTextarea ? (
                            ...
                            <input
                              ...
                              className="w-full bg-slate-50 border border-slate-200 rounded-xl xl:rounded-2xl px-4 py-2 text-sm text-slate-800 outline-none focus:border-indigo-500 transition-all"
                            />
                          )}
                        </div>
                      );
