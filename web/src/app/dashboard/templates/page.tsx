    ...
    <div className="flex-1 flex flex-col gap-6 xl:gap-8 max-w-7xl mx-auto w-full">
      {!selectedId ? (
        ...
        <div className="flex-1 flex flex-col gap-6 xl:gap-8 w-full animate-fade-in">
          ...
          </div>          {/* TEMPLATE WORKSPACE PANEL (FULL WIDTH) */}
          <div className="w-full flex flex-col gap-5 xl:gap-6 bg-white border border-slate-200 p-5 xl:p-6 rounded-2xl xl:rounded-3xl min-h-[450px] shadow-sm animate-fade-in">
                      ...
                      <div key={varName} className="flex flex-col gap-1.5 xl:gap-2">
                        ...
                        {isTextarea ? (
                          ...
                          <input
                            ...
                            className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-sm text-slate-800 outline-none focus:border-indigo-500 transition-all"
                          />
                        )}
                      </div>
                    );
